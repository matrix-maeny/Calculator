...
public class TimeConverterActivity extends AppCompatActivity implements TimeConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.TimeEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Time converter");
    ...
    public void openDialog(int flag) {
        ...
        TimeConverterFragment bottomUnitsFragment = new TimeConverterFragment(bText1, bText2, flag);
