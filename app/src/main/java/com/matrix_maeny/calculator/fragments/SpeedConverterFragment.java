...
public class SpeedConverterFragment extends BottomSheetDialogFragment {
    ...
    public SpeedConverterFragment(TextView textView1, TextView textView2, int flag) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // setting text
        frText1.setText("Meter per second m/s");
        frText2.setText("Kilometer per second km/s");
        frText3.setText("Kilometer per hour km/h");
        frText4.setText("Mile per hour mph");
        frText5.setText("Inch per second ips");
