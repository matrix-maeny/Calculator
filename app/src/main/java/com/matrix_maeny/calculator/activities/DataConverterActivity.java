...
import com.matrix_maeny.calculator.fragments.DataConverterFragment;
import com.matrix_maeny.calculator.fragments.WeightConverterFragment;

import org.mariuszgromada.math.mxparser.*;

import org.w3c.dom.Text;

public class DataConverterActivity extends AppCompatActivity implements DataConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.DataEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Data converter");
    ...
    public void openDialog(int flag) {
        ...
        DataConverterFragment bottomUnitsFragment = new DataConverterFragment(bText1, bText2, flag);
