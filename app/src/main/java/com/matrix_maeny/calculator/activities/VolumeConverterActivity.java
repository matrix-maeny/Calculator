...
import com.matrix_maeny.calculator.fragments.VolumeConverterFragment;

import org.mariuszgromada.math.mxparser.*;

import org.w3c.dom.Text;

public class VolumeConverterActivity extends AppCompatActivity implements VolumeConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.VolumeEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Volume converter");
    ...
    public void openDialog(int flag) {
        ...
        VolumeConverterFragment bottomUnitsFragment = new VolumeConverterFragment(bText1, bText2, flag);
