...
import com.matrix_maeny.calculator.fragments.LengthConverterFragment;
import com.matrix_maeny.calculator.fragments.LengthConverterFragment;
...
public class LengthConverterActivity extends AppCompatActivity implements LengthConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.LengthEvaluationFucntion(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Length converter");
        ...
        bUnit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openDialog(1);
                ///Toast.makeText(LengthConverterActivity.this, "Length conversion Activity", Toast.LENGTH_SHORT).show();
                sizeMinimizer(bText1);
                sizeMinimizer(bText2);
    ...
    public void openDialog(int flag) {
        ...
        LengthConverterFragment bottomUnitsFragment = new LengthConverterFragment(bText1, bText2, flag);
