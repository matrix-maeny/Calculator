...
public class AreaActivity extends AppCompatActivity implements BottomUnitsFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.AreaEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Area converter");
    ...
    public void openDialog(int flag) {
        ...
        BottomUnitsFragment bottomUnitsFragment = new BottomUnitsFragment(bText1, bText2, flag);
