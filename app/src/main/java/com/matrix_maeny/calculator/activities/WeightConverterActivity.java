...
public class WeightConverterActivity extends AppCompatActivity implements WeightConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.WeightEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Weight converter");
    ...
    public void openDialog(int flag) {
        ...
        WeightConverterFragment bottomUnitsFragment = new WeightConverterFragment(bText1, bText2, flag);
