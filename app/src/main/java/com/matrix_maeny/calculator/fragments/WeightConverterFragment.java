...
public class WeightConverterFragment extends BottomSheetDialogFragment {
    ...
    public WeightConverterFragment(TextView textView1, TextView textView2, int flag) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // setting text
        frText1.setText("Tonne t");
        frText2.setText("Kilogram kg");
        frText3.setText("Gram g");
        frText4.setText("Milligram mg");
        frText5.setText("Micro gram µg");
        frText6.setText("Quintal q");
        frText7.setText("Pound lb");
        frText8.setText("Ounce oz");
        frText9.setText("Carat ct");
        frText10.setText("Grain gr");
