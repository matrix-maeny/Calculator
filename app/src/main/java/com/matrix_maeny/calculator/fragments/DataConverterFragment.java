...
public class DataConverterFragment extends BottomSheetDialogFragment {
    ...
    public DataConverterFragment(TextView textView1, TextView textView2, int flag) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // setting text
        frText1.setText("Byte B");
        frText2.setText("Kilobyte KB");
        frText3.setText("Megabyte MB");
        frText4.setText("Gigabyte GB");
        frText5.setText("Terabyte TB");
        frText6.setText("Petabyte PB");
