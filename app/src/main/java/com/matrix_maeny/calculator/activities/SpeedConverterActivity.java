...
import com.matrix_maeny.calculator.fragments.SpeedConverterFragment;

import org.mariuszgromada.math.mxparser.*;

import org.w3c.dom.Text;

public class SpeedConverterActivity extends AppCompatActivity implements SpeedConverterFragment.BottomFragmentListner {
    ...
    void evaluateFunction(double val) {
        ...
        double result = converterFunction.SpeedEvaluationFunction(btnUnit1Text, btnUnit2Text, val);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commonToolbar.setTitle("Speed converter");
    ...
    public void openDialog(int flag) {
        ...
        SpeedConverterFragment bottomUnitsFragment = new SpeedConverterFragment(bText1, bText2, flag);
